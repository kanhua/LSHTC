...
wget https://www.dropbox.com/s/sls1wbkhscz089p/trainSparseMtx.npy
wget https://www.dropbox.com/s/i60bn360oyv18f9/testSparseMtx.npy
...
mv trainSparseMtx.npy ./meta\ data/
mv testSparseMtx.npy ./meta\ data/